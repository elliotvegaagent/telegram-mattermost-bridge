...
- формат авторов: в обеих системах префикс `Антон: ` выводится курсивом,
  а основной текст продолжается обычным шрифтом в той же строке;
...
- удаление Mattermost-поста удаляет все связанные сообщения bridge-бота в
  Telegram без отдельной нотификации (в пределах 48-часового лимита Telegram);
